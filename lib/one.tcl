...
db_0or1row get_transaction_comments "select response_reason_text, avs_code
      ...
      where transaction_id = :transaction_id and amount = :amount and (substr(txn_attempted_type,1,9) = 'AUTH_ONLY' or substr(txn_attempted_type,1,12) = 'AUTH_CAPTURE') and response_reason_text is not null and avs_code is not null limit 1"
